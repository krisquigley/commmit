class Retrospective < ApplicationRecord
  ...
  scope :retros_with_end_dates, ->(sprint_ids) { where(sprint_id: sprint_ids).joins(:sprint).map {|r| { end_date: r.sprint.end_date, average_happiness: r.average_happiness} }
                                                 .group_by {|i| i[:end_date]}.sort }
