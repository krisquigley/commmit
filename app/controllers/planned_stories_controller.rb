...
class PlannedStoriesController < ApplicationController
  ...
  def mark_as_done
    ...
    @planned_story.mark_as_done unless @planned_story.completed_at.present?
  ...
  def mark_as_not_done
    @planned_story = PlannedStory.find(params[:planned_story_id])
    @planned_story.mark_as_not_done
  ...
  def set_planned_stories
    @planned_stories = all_planned_stories.todo.order(created_at: :asc, commmit_goal: :asc)
  end

  def set_completed_stories
    @completed_stories = all_planned_stories.completed.order(commmit_goal: :desc, updated_at: :asc)
  end
